...
<li><a href="/scripts/portDetect.sh">portDetect.sh</a>: To detect which ports in your local network are open/li>
<li><a href="/scripts/gen_passwd.sh">gen_passwd.sh</a>: Password generator, this generator can create passwords of different security levels and display them on screen or dump them to a file./li>
<li><a href="/scripts/event_register.sh">event_register.sh</a>: System event notifier, this script monitors certain events, such as reboots, logins, important file changes, and sends notifications by e-mail.</li>
</ol>
