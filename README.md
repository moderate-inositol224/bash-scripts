...
<li><a href="/scripts/update-system">Get-Temperature.sh</a>: Automating System Updates</li>
<li><a href="/scripts/network_check.sh">Get-Temperature.sh</a>: Network Connectivity and Health Check</li>
</ol>
